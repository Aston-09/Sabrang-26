      ...
      try {
        ...
        if (snap.empty) {
          const mockVolunteers = [
            { name: 'Aman Sharma', team: 'Registration Team', email: 'aman@sabrang.com', role: 'Team Leader' },
            { name: 'Tanya Saxena', team: 'Registration Team', email: 'tanya@sabrang.com', role: 'Volunteer' },
            { name: 'Devam', team: 'Technical Team', email: 'devam@sabrang.com', role: 'Team Leader' },
            { name: 'Manant Srivastava', team: 'Technical Team', email: 'manant@sabrang.com', role: 'Volunteer' },
            { name: 'Rohan Gupta', team: 'Technical Team', email: 'rohan@sabrang.com', role: 'Volunteer' },
            { name: 'Vikram Singh', team: 'Discipline Team', email: 'vikram@sabrang.com', role: 'Team Leader' },
            { name: 'Aditi Rao', team: 'Discipline Team', email: 'aditi@sabrang.com', role: 'Volunteer' },
            { name: 'Neha Sharma', team: 'Hospitality Team', email: 'neha@sabrang.com', role: 'Team Leader' },
            { name: 'Rahul Kapoor', team: 'Hospitality Team', email: 'rahul@sabrang.com', role: 'Volunteer' },
            { name: 'Sanya Mehta', team: 'Decoration Team', email: 'sanya@sabrang.com', role: 'Team Leader' },
            { name: 'Karan Johar', team: 'Decoration Team', email: 'karan@sabrang.com', role: 'Volunteer' },
            { name: 'Priya Malhotra', team: 'Anchoring Team', email: 'priya@sabrang.com', role: 'Team Leader' },
            { name: 'Kabir Sen', team: 'Anchoring Team', email: 'kabir@sabrang.com', role: 'Volunteer' },
            { name: 'Arjun Reddy', team: 'Photography Team', email: 'arjun@sabrang.com', role: 'Team Leader' },
            { name: 'Meera Nair', team: 'Photography Team', email: 'meera@sabrang.com', role: 'Volunteer' },
            { name: 'Riya Sen', team: 'Social Media Team', email: 'riya@sabrang.com', role: 'Team Leader' },
            { name: 'Yash Vardhan', team: 'Social Media Team', email: 'yash@sabrang.com', role: 'Volunteer' },
          ];
    ...
    <div className="space-y-10  font-adminBody">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-admin-muted font-bold text-xs uppercase tracking-wider">Manage volunteer duty assignments for SABRANG’26</p>
        </div>
        <a 
